...
namespace HexGame.Tests
{
    ...
    public class PathfinderTests
    {
        ...
        public void FindPath_DirectNeighbors_ReturnsTwoHexPath()
        {
            ...
            PathResult result = Pathfinder.FindPath(grid, start, target);
        ...
        {
            HexData start = grid.GetHexAt(5, 5);
            PathResult result = Pathfinder.FindPath(grid, start, start);
        ...
        public void FindPath_DisconnectedGrid_ReturnsFailure()
        {
            ...
            PathResult result = Pathfinder.FindPath(smallGrid, start, target);
        ...
        public void FindPath_HighElevationGap_ReturnsFailure()
        {
            ...
            // Try to cross the 'wall' at 1,0 with max change of 1
            PathResult result = Pathfinder.FindPath(grid, grid.GetHexAt(0, 0), grid.GetHexAt(2, 0), 1f);
            ...
            result = Pathfinder.FindPath(grid, grid.GetHexAt(0, 5), grid.GetHexAt(2, 5), 1f);
